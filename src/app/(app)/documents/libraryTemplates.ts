...
export const DOCUMENT_LIBRARY: LibraryDocument[] = [
  ...
  // â”€â”€ EHS Programs â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "The following SOPs must be followed when working with hazardous chemicals:\n\nâ€¢ Review the Safety Data Sheet (SDS) for every chemical before use. SDSs are maintained in the Chemical Inventory Management System and in each laboratory.\nâ€¢ Wear the minimum PPE required: safety glasses with side shields, nitrile gloves, and a lab coat at all times in the laboratory.\nâ€¢ Use the chemical fume hood for any operation involving volatile chemicals, chemicals with occupational exposure limits, or chemicals with warning odors.\nâ€¢ Never work alone when using particularly hazardous substances (carcinogens, reproductive toxins, or acute toxins as defined in Section 5).\nâ€¢ Confine long hair, avoid loose clothing, and wear closed-toe shoes. No food, drink, or cosmetics in the laboratory.\nâ€¢ Decontaminate work surfaces after each use and when chemical spills occur.\nâ€¢ All waste generated from chemical use must be disposed of through the Hazardous Waste Management Program."
      },
      {
        heading: "4. Particularly Hazardous Substances (PHS)",
        body: "Particularly Hazardous Substances (PHS) include: (a) select carcinogens as defined in 29 CFR 1910.1450; (b) reproductive toxins; and (c) substances with high acute toxicity. The following chemicals used at [COMPANY NAME] are designated as PHS and require enhanced controls:\n\n[LIST PHS CHEMICALS â€” e.g., Formaldehyde, Ethidium bromide, Chloroform, Methanol]\n\nAdditional requirements for PHS use: (1) Prior approval from the CHO or laboratory supervisor is required before any new PHS procedure is started. (2) PHS work must be conducted in a designated area clearly posted with the applicable hazard warning. (3) Employees must be specifically trained on PHS hazards before first use. (4) Decontamination procedures must be established and followed before removal of materials from the designated area. (5) Medical surveillance may be required as specified in Section 6."
      },
      {
  ...
  {
    id: "lib-003",
    title: "Exposure Control Plan â€” Bloodborne Pathogens",
    category: "plan",
    group: "EHS Programs",
    ...
    sections: [
      ...
      {
        heading: "2. Implementation â€” Controls and PPE",
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Respirators will be selected based on the respiratory hazard(s) to which employees may be exposed and on workplace and user factors. The following respirators are currently approved for use at [COMPANY NAME]:\n\nâ€¢ N95 filtering facepiece respirators: approved for tasks with airborne particulates below IDLH (e.g., nuisance dust, non-oil-based aerosols below the PEL)\nâ€¢ Half-face APR with OV/P100 cartridges: approved for organic vapor hazards below IDLH (e.g., formaldehyde work, solvent use)\nâ€¢ Full-face APR with OV/P100 cartridges: approved for eye/respiratory hazard combination below IDLH\nâ€¢ SCBA or supplied-air respirator: required for IDLH atmospheres, confined space entry, and emergency response\n\nNo employees are permitted to use a respirator not on the approved list without prior approval from the Program Administrator and completion of the required medical evaluation and fit test for the new respirator."
      },
      {
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "LABORATORY AREAS (Labs A, B, C, Cell Culture Room, Autoclave Room):\nâ€¢ Eye protection: Safety glasses with side shields (minimum); chemical splash goggles required when using corrosives, solvents, or biohazardous materials\nâ€¢ Hand protection: Nitrile examination gloves (minimum); butyl rubber or neoprene gloves for formaldehyde or strong acids/bases\nâ€¢ Body protection: Lab coat (cotton or flame-resistant for specific tasks); fluid-resistant gown for BSL-2 work\nâ€¢ Foot protection: Closed-toe, closed-heel shoes; no sandals or open-toe footwear in any laboratory area\n\nCHEMICAL STORAGE AREAS:\nâ€¢ Eye protection: Chemical splash goggles required\nâ€¢ Hand protection: Chemical-resistant gloves appropriate to the chemicals being handled\nâ€¢ Body protection: Chemical-resistant apron\n\nWASTE MANAGEMENT / LOADING DOCK:\nâ€¢ Eye protection: Safety glasses with side shields\nâ€¢ Hand protection: Puncture-resistant gloves for handling sharps containers; nitrile for chemical waste\nâ€¢ Foot protection: Safety-toed footwear recommended"
      },
      {
...

  {
    ...
    sections: [
      ...
      {
        heading: "3. Lockout/Tagout Procedure â€” General Steps",
    ...
    sections: [
      {
        ...
        body: "Shelter-in-Place (SIP) directives will be issued by [EHS MANAGER / FACILITY MANAGER / BUILDING SECURITY] when evacuation would expose employees to greater risk than sheltering. Shelter-in-Place situations include:\n\nâ€¢ SEVERE WEATHER: Tornado warning (sirens, NWS warning), severe lightning, or high winds that make outdoor movement dangerous\nâ€¢ OUTDOOR CHEMICAL RELEASE: Plume from an external industrial or transportation incident that has been identified in the area\nâ€¢ ACTIVE THREAT: Law enforcement-directed shelter for active shooter, civil unrest, or other threat to building occupants\nâ€¢ SHELTER-IN-PLACE COMMAND: Notification via PA system, mass communication system, or Floor Warden instruction stating 'Shelter-in-Place â€” do not leave the building'"
      },
      {
        heading: "2. Shelter Locations and Procedures",
        body: "Upon receiving a Shelter-in-Place directive:\n\n1. Move inside immediately. If you are outside, go to the nearest building entrance.\n2. Proceed to the designated shelter area for your location:\n   â€¢ TORNADO/SEVERE WEATHER: Move to interior rooms on the lowest floor away from windows. Avoid stairwells and hallways with exterior windows. Designated tornado shelter areas: [ROOM NUMBERS]\n   â€¢ CHEMICAL RELEASE (outdoor): Move to an interior room on an upper floor with windows and HVAC access closed. Designated chemical shelter areas: [ROOM NUMBERS]\n3. Account for all personnel in your area.\n4. Do not leave until authorized by the all-clear signal or communication from management.\n5. Keep communication devices (phone) available for updates from management.\n6. All-clear signal: [DESCRIBE â€” e.g., PA announcement, text message, direct supervisor communication]"
      },
      {
        heading: "3. Communication During Shelter Events",
        body: "During a shelter-in-place event: (1) Monitor the emergency notification system â€” [COMPANY NAME] will send updates via [TEXT SYSTEM / EMAIL / PA]. (2) Check local emergency alerts via [ALERT SYSTEM, e.g., Wireless Emergency Alerts, NOAA Weather Radio]. (3) Supervisors will conduct headcount and report to the Incident Commander by phone.\n\nDo NOT call 911 unless there is an immediate life safety emergency within the facility. Keep phone lines clear for official emergency communications. If a person requires medical assistance during a shelter event, call [INTERNAL EMERGENCY NUMBER] first."
      },
    ],
  },

  // â”€â”€ Biosafety â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

  {
    id: "lib-016",
    title: "Biosafety Manual â€” BSL-2 Operations",
    category: "guideline",
    group: "Biosafety",
    ...
    sections: [
      {
        ...
        body: "This Biosafety Manual establishes the procedures and requirements for all Biosafety Level 2 (BSL-2) laboratory operations at [COMPANY NAME], in accordance with the CDC/NIH Biosafety in Microbiological and Biomedical Laboratories (BMBL), 6th Edition. BSL-2 is appropriate for work involving agents associated with human disease but for which exposure risk is moderate and laboratory exposures rarely cause infection from incidental exposures.\n\nBiological agents handled at BSL-2 at [COMPANY NAME] include: [LIST SPECIFIC AGENTS â€” e.g., human cell lines, primary human tissues, Biosafety Level 2 select agents if applicable]. This manual applies to all personnel working in designated BSL-2 laboratories: [LAB ROOM NUMBERS]. The Institutional Biosafety Officer (IBO) is [NAME, CONTACT]. All BSL-2 protocols must be reviewed and approved by the Institutional Biosafety Committee (IBC) before work begins."
      },
      {
        heading: "2. BSL-2 Standard Practices",
        body: "The following standard practices are required in all BSL-2 laboratories:\n\nâ€¢ Access is restricted to persons whose presence is required. Doors remain closed when work with BSL-2 agents is in progress.\nâ€¢ Mouth pipetting is strictly prohibited. Mechanical pipetting devices must be used.\nâ€¢ All procedures involving potential splash or aerosol generation must be performed in a Class II biological safety cabinet (BSC).\nâ€¢ Work surfaces are decontaminated with an appropriate disinfectant (see Disinfection SOP) after each use and immediately after any spill of viable material.\nâ€¢ All biological waste is decontaminated prior to disposal by autoclaving, chemical disinfection, or another validated inactivation method.\nâ€¢ Personnel must wash hands after working with potentially hazardous materials and before leaving the laboratory.\nâ€¢ PPE: lab coat (dedicated to the lab), gloves appropriate to the procedure, and eye/face protection when working with material that may splash."
      },
      {
    ...
    sections: [
      {
        ...
        body: "Biohazardous waste at [COMPANY NAME] is categorized as follows, and must be placed in the appropriate container at the point of generation:\n\nâ€¢ SOFT/NON-SHARP BIOHAZARDOUS WASTE: Contaminated gloves, wipes, pipettes, tubes, plates â€” Red autoclave bags in red biohazard boxes\nâ€¢ SHARPS: Needles, syringes, lancets, broken glass from biohazardous areas, scalpels â€” Approved sharps containers (yellow or red, UN-certified, not more than 3/4 full when closed)\nâ€¢ LIQUID BIOHAZARDOUS WASTE: Culture supernatants, media, reagents â€” Sealed containers for autoclave decontamination or chemical disinfection\nâ€¢ ANIMAL CARCASSES/TISSUES (if applicable): Placed in sealed biohazard bags, stored in freezer [LOCATION] for scheduled pickup by [VENDOR]\n\nNever mix sharps with soft waste. Never place glass (even non-biohazardous glass) in soft waste bags without sharps-resistant secondary packaging."
      },
      {
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "â€¢ NEVER recap needles using both hands or any technique that involves directing the needle toward any part of the body. One-handed scoop method may be used only when absolutely required by the procedure.\nâ€¢ Dispose of used needles immediately after use into the sharps container â€” do not set down on the bench.\nâ€¢ Do not bend, break, or remove needles from syringes by hand.\nâ€¢ Do not overfill sharps containers â€” seal when 3/4 full.\nâ€¢ Broken glass must not be picked up by hand â€” use a brush and dustpan, forceps, or tongs. Broken glass from biohazardous areas goes to the sharps container; non-biohazardous broken glass goes to a puncture-resistant 'broken glass' container labeled as such.\nâ€¢ Scalpels must be handled with forceps or a scalpel handle when removing blades â€” never by hand.\nâ€¢ When working with sharps in BSL-2 areas: wear double gloves for procedures that present the highest risk of needlestick (retro-orbital injections, cardiac puncture)."
      },
      {
  ...
  // â”€â”€ Waste Management â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    sections: [
      {
        ...
        body: "Chemical waste must be identified and segregated at the point of generation to ensure compatibility, safety, and regulatory compliance. NEVER mix chemicals that are reactive with each other. The following segregation rules must be followed:\n\nâ€¢ Acids must be kept separate from bases and cyanides\nâ€¢ Oxidizers must be kept separate from flammables and organics\nâ€¢ Halogenated solvents (chloroform, methylene chloride, carbon tetrachloride) must be kept separate from non-halogenated solvents (acetone, ethanol, toluene) â€” they have different disposal costs and methods\nâ€¢ Aqueous waste must be kept separate from organic waste\nâ€¢ Reactive materials (peroxides, water-reactive metals, pyrophorics) require special handling â€” contact EHS before disposing of reactive waste\n\nDo NOT pour chemical waste down the drain unless it has been explicitly approved by the EHS Manager and is compliant with local wastewater treatment standards."
      },
      {
        heading: "2. Container Requirements and Labeling",
        body: "Chemical waste containers must be: (a) compatible with the waste â€” use the same material as the original container when possible; (b) in good condition â€” no rust, swelling, or damage; (c) securely sealed when not adding waste; and (d) labeled as 'Hazardous Waste' from the time waste is first added.\n\nHAZARDOUS WASTE LABELS must include: (a) the words 'Hazardous Waste'; (b) the composition and physical state of the waste (e.g., 'Halogenated Solvent Waste â€” Chloroform/Methanol'); (c) the generator's name, address, and EPA ID; and (d) the accumulation start date when the container is moved to the Central Accumulation Area. Use the [COMPANY NAME] standard Hazardous Waste label, available from [EHS / SAFETY SUPPLY ROOM]. Do NOT use standard Biohazard labels on chemical waste or vice versa."
      },
      {
    ...
    sections: [
      {
        ...
        body: "The EPA Universal Waste Rule (40 CFR 273) establishes streamlined management requirements for certain widely generated hazardous wastes: batteries, pesticides, mercury-containing equipment, and lamps (including fluorescent, HID, and LED lamps containing mercury). At [COMPANY NAME], the primary universal wastes generated include:\n\nâ€¢ LAMPS: Fluorescent tubes, CFLs, UV-B lamps, HID bulbs from laboratory equipment\nâ€¢ BATTERIES: Rechargeable nickel-cadmium and lithium batteries, lead-acid batteries from UPS units\nâ€¢ MERCURY-CONTAINING EQUIPMENT: Thermometers, barometers, switches\n\nUniversal wastes must be stored in a designated container or area, in good condition, and clearly labeled 'Universal Waste â€” [type]' and the accumulation start date. Maximum accumulation quantity for a Small Quantity Handler: 5,000 kg total of all universal wastes at one time."
      },
      {
        heading: "2. Collection Points and Disposal",
        body: "LAMP COLLECTION: Spent fluorescent and UV lamps must be placed in the original box or a cardboard box with padding to prevent breakage. Do not break lamps â€” broken lamps must be managed as RCRA hazardous waste (mercury D009), not universal waste. Lamp collection containers are located at [LOCATIONS]. Containers are sent to [RECYCLER NAME] for recycling.\n\nBATTERY COLLECTION: Rechargeable batteries (NiCd, Li-ion) must be taped at the terminals before collection to prevent short circuits. Battery collection containers are at [LOCATIONS]. Lead-acid batteries (from UPS) are returned to the vendor for recycling.\n\nMERCURY EQUIPMENT: Mercury thermometers, manometers, and switches must be placed in a sealed container with enough absorbent material to contain the mercury if breakage occurs. Label 'Universal Waste â€” Mercury-containing equipment'. Contact EHS to arrange disposal with [VENDOR]."
      },
      {
        heading: "3. Broken Lamp and Mercury Spill Response",
        body: "BROKEN FLUORESCENT LAMP: Ventilate the area (open windows, leave for 15 minutes). Do not use a vacuum cleaner â€” this disperses mercury vapor. Collect glass fragments with stiff cardboard or sticky tape. Place all materials in a sealed plastic bag. Label as 'Hazardous Waste â€” Mercury' and notify EHS for proper disposal.\n\nMERCURY SPILL: Evacuate the area. Call EHS: [PHONE]. Do not walk through mercury or use a vacuum. Mercury spills require specialized cleanup by [EHS / CONTRACTED MERCURY REMEDIATION VENDOR]. Keep the area closed and ventilated until cleanup is complete."
      },
    ],
  },
    ...
    sections: [
      {
        ...
        body: "Pharmaceutical waste generated at [COMPANY NAME] must be evaluated for regulatory status before disposal. Classifications include:\n\nâ€¢ NON-RCRA HAZARDOUS PHARMACEUTICAL WASTE: Pharmaceuticals not meeting RCRA hazardous criteria. May be disposed of through a licensed pharmaceutical waste contractor or, in some cases, via approved wastewater or solid waste pathways â€” consult EHS and state regulations.\nâ€¢ RCRA HAZARDOUS PHARMACEUTICAL WASTE (U-Listed): Commercial chemical products that are discarded and appear on the U list (e.g., U-listed chemotherapy drugs, certain solvents). Must be managed as RCRA hazardous waste.\nâ€¢ RCRA ACUTELY HAZARDOUS PHARMACEUTICAL WASTE (P-Listed): Discarded commercial chemical products on the P list (e.g., certain chemotherapy drugs, some controlled substances). Acutely hazardous â€” subject to 1-quart/1-kg SAA limits and heightened management.\nâ€¢ DEA-CONTROLLED SUBSTANCES: Must be surrendered to an authorized DEA-registered collector or reverse distributor. Contact [DEA COORDINATOR / PHARMACY / EHS] for controlled substance disposal procedures."
      },
      {
        heading: "2. Collection, Labeling, and Disposal",
        body: "Pharmaceutical waste must be collected in blue-lidded pharmaceutical waste containers (non-hazardous) or properly labeled RCRA hazardous waste containers (for P-listed and U-listed pharmaceuticals). Pharmaceutical waste must NOT be mixed with regular trash, biohazardous waste, or general chemical waste unless specifically approved by EHS.\n\nLABELING: Containers must be labeled 'Pharmaceutical Waste' at minimum. For RCRA hazardous pharmaceutical waste: apply a Hazardous Waste label with waste description (e.g., 'U-Listed Pharmaceutical Waste â€” Cyclophosphamide') and accumulation start date. Disposal is arranged through [PHARMACEUTICAL WASTE CONTRACTOR NAME, CONTACT]. Schedule pickup when containers are 3/4 full."
      },
    ],
  },

  // â”€â”€ Lab SOPs â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    sections: [
      {
        ...
        body: "Chemical fume hoods are local exhaust ventilation devices that protect workers from inhalation exposure to hazardous chemical vapors, gases, mists, and aerosols. They exhaust air to the outdoors through the building HVAC system. Chemical fume hoods must be used for: all work involving volatile chemicals with OELs; all work with chemicals that have strong odors; all work with toxic, corrosive, or reactive chemicals that could produce hazardous vapors; and all chemical heating or evaporation procedures.\n\nChemical fume hoods must NOT be used as: biological safety cabinets (they provide no protection against biological aerosols); storage cabinets for chemicals (unless temporary â€” excess chemical in the hood blocks airflow); or as substitutes for enclosures designed to contain explosions."
      },
      {
        heading: "2. Pre-Use Inspection and Proper Use",
        body: "BEFORE USE:\nâ€¢ Verify the hood monitor alarm is functioning and not in alarm. If the alarm is activated, do not use the hood â€” report immediately to Facilities.\nâ€¢ Check the certification sticker â€” fume hoods must be certified annually. Do not use an uncertified hood.\nâ€¢ Turn on the hood blower if not already operating (many hoods run continuously â€” verify locally).\nâ€¢ Position the sash at or below the working height mark indicated on the sash rail. The recommended work sash height is [SPECIFY â€” typically 18 inches] for maximum face velocity.\n\nDURING USE:\nâ€¢ Keep all materials at least 6 inches inside the sash opening.\nâ€¢ Do not block the rear baffle openings with equipment or materials.\nâ€¢ Work slowly â€” rapid arm movements in and out of the hood disrupt airflow and can pull contaminants into the breathing zone.\nâ€¢ Keep the sash at or below the certified work height at all times during chemical use.\nâ€¢ Do not put your head inside the hood."
      },
      {
    ...
    sections: [
      {
        ...
        body: "Chemicals that could react dangerously if mixed must be physically separated. Do not store incompatible chemicals in the same cabinet, secondary containment tray, or refrigerator. Key segregation requirements:\n\nâ€¢ FLAMMABLES (Class IB and IC solvents): Store in approved flammable storage cabinets or flammable-rated refrigerators. Separate from oxidizers by at least 20 feet or a 30-minute fire wall.\nâ€¢ CORROSIVES (acids and bases): Acids and bases must be stored in separate cabinets or separate secondary containment trays â€” do not mix. Strong oxidizing acids (nitric acid, perchloric acid) must be stored separately from organic acids and flammable materials.\nâ€¢ OXIDIZERS: Store in a dry location away from flammables, organics, and reducing agents.\nâ€¢ TOXICS AND CARCINOGENS: Store in a locked cabinet with secondary containment. Access limited to trained personnel.\nâ€¢ CRYOGENICS: Store in insulated dewars in well-ventilated areas. Dewars must be vented â€” never seal a cryogen dewar."
      },
      {
        heading: "2. Quantity Limits and Container Labeling",
        body: "QUANTITY LIMITS: Laboratory working quantities of flammable and combustible liquids are limited per NFPA 45 and the International Fire Code. Maximum quantities per 100 square feet of laboratory space: [INSERT NFPA 45 TABLE OR FACILITY-SPECIFIC LIMITS]. Quantities exceeding working limits must be stored in the approved flammable storage room [LOCATION].\n\nCONTAINER LABELING: All chemical containers must be labeled with at minimum: chemical name, hazard warning(s) or GHS pictogram(s), and owner/lab identification. Secondary containers (aliquots, working solutions) must be labeled with chemical name and concentration. Labels must be legible and resistant to the working conditions. Never relabel a container with a different chemical â€” use a new, clean container.\n\nSECONDARY CONTAINMENT: All liquid chemicals stored in cabinets or on benches must be in secondary containment (trays, bins) capable of holding the volume of the largest container plus 10%."
      },
      {
    ...
    sections: [
      {
        ...
        body: "Glove selection must be based on the specific chemical(s) being handled, task duration, and expected contact level. Permeation rate and breakthrough time data from glove manufacturer testing guides must be used for all non-routine applications. General guidance:\n\nâ€¢ NITRILE (disposable, 4-6 mil): Good protection for aqueous solutions, dilute acids and bases, non-chlorinated solvents; standard laboratory glove. Poor protection for chloroform, methylene chloride, MEK â€” check permeation data.\nâ€¢ LATEX (disposable): Similar to nitrile; allergy risk makes nitrile preferred. Avoid where latex sensitivity is present.\nâ€¢ NEOPRENE: Good for oils, greases, moderate acids and bases; common for wet chemical work.\nâ€¢ BUTYL RUBBER: Best resistance to ketones, esters, alcohols, and certain acids (including perchloric and nitric acid). Required for formaldehyde handling.\nâ€¢ SILVER SHIELD / BARRIER LAMINATE: Broad spectrum protection, including many chemicals nitrile does not protect against. Use when chemical identity is uncertain.\n\nDouble-gloving (two pairs of disposable nitrile) is recommended for biohazardous materials, highly toxic chemicals, and prolonged contact with concentrated chemicals."
      },
      {
        heading: "2. Eye and Face Protection",
        body: "Selection of eye protection depends on the hazard type and the task:\n\nâ€¢ SAFETY GLASSES with side shields (ANSI Z87.1): Minimum requirement for all personnel in laboratory areas. Protects against impact and incidental splashes from above. Not adequate for chemical splash hazards.\nâ€¢ CHEMICAL SPLASH GOGGLES (indirect-vent): Required when working with liquids that could splash â€” corrosives, solvents, biohazardous liquids. Must seal against the face without gaps. Required when pouring, transferring, mixing, or heating chemicals.\nâ€¢ FACE SHIELD (ANSI Z87.1): Used over safety glasses or goggles when large splash, spray, or projectile risk exists â€” distillation, autoclave opening, emergency shower administration. A face shield alone does not meet the eye protection requirement for chemical hazards.\nâ€¢ LASER SAFETY EYEWEAR: Wavelength-specific protection is required for each laser type. Consult the Laser Safety Program for specific requirements."
      },
      {
        heading: "3. Lab Coat and Respiratory Protection",
        body: "LAB COAT SELECTION: Lab coats protect clothing and provide some skin protection. Selection considerations:\nâ€¢ Cotton or cotton-poly blend: Standard for most chemical lab work. Provides no flame resistance â€” do not use with pyrophorics or when working near open flames without additional protection.\nâ€¢ Flame-resistant (FR): Required when working with flammable solvents at elevated temperatures, open flames, or pyrophorics.\nâ€¢ Fluid-resistant/disposable Tyvek: For BSL-2 work, handling biohazardous materials, or procedures with high splash potential.\n\nLab coats must be removed before leaving the laboratory and must not be worn in non-laboratory areas (cafeteria, offices). Lab coats used in biohazardous work must be decontaminated before laundering.\n\nRESPIRATORY PROTECTION: Selection of respiratory protection requires a hazard assessment and must be conducted under the Respiratory Protection Program. Voluntary use of dust masks requires a physician determination that use will not harm health, and the employee must be provided with Appendix D of 29 CFR 1910.134. Do not wear a respirator without training and fit testing except for N95 voluntary use per the above provisions."
      },
    ],
  },
    ...
    sections: [
      {
        ...
        body: "Medical surveillance is required for employees with occupational exposure to substances regulated under OSHA substance-specific standards that mandate medical surveillance, and for employees who develop signs or symptoms consistent with occupational exposure. At [COMPANY NAME], the following regulated substances and their surveillance requirements apply:\n\nâ€¢ FORMALDEHYDE (29 CFR 1910.1048): Medical surveillance required for employees exposed at or above the action level (0.5 ppm TWA) or STEL. Medical examination must include: medical and work history, pulmonary function tests, and any examination deemed appropriate by the physician.\nâ€¢ BLOODBORNE PATHOGENS (29 CFR 1910.1030): Hepatitis B vaccination series offered to all employees with occupational exposure. Post-exposure medical evaluation as specified in the Exposure Control Plan.\nâ€¢ HAZARDOUS CHEMICALS / CHP (29 CFR 1910.1450): Medical consultations required when employees develop signs/symptoms of chemical exposure, or when exposure monitoring indicates PEL exceedance.\n\nAdditional surveillance requirements may apply based on the specific chemicals in use at [COMPANY NAME]. The EHS Manager reviews substance-specific requirements annually."
      },
      {
    ...
    sections: [
      {
        ...
        body: "Facility: [COMPANY NAME â€” SITE]\nDate of Review: _______________\nReviewed by (Chemical Hygiene Officer): _______________\n\nINSTRUCTIONS: Review each item and mark Y (compliant / complete), N (non-compliant / incomplete), or N/A. Add notes as needed. The completed checklist must be attached to the CHP as evidence of annual review.\n\nSECTION A â€” PLAN COMPLETENESS\nâ˜ CHP contains all required elements per 29 CFR 1910.1450(e)\nâ˜ Exposure limits (PELs, TLVs) are current for all regulated substances in use\nâ˜ PPE requirements have been updated to reflect current chemical inventory\nâ˜ Particularly Hazardous Substances (PHS) list has been reviewed and updated\nâ˜ Emergency procedures are current and reflect current facility layout\n\nSECTION B â€” IMPLEMENTATION\nâ˜ Training records have been reviewed â€” all covered employees trained within the past year\nâ˜ Exposure monitoring data is current (within required monitoring frequency)\nâ˜ Medical surveillance records are complete for all required employees\nâ˜ SOP library has been reviewed â€” outdated SOPs have been revised or retired\nâ˜ Fume hood certification records are current (within 12 months)\n\nSECTION C â€” INCIDENT REVIEW\nâ˜ Chemical exposure incidents from the past year have been reviewed\nâ˜ Root causes have been identified and corrective actions completed\nâ˜ Corrective actions have been incorporated into the CHP or SOPs where applicable\n\nSECTION D â€” SIGN-OFF\nThe Chemical Hygiene Plan has been reviewed and is considered adequate to protect employees from health hazards associated with chemicals in the laboratory.\n\nCHO Signature: _______________ Date: _______________\nManagement Review: _______________ Date: _______________"
      },
    ],
  },
    ...
    sections: [
      {
        ...
        body: "Laboratory/Area: _______________\nInspection Date: _______________\nInspector(s): _______________\nLab Supervisor / PI: _______________\n\nRATING SCALE: S = Satisfactory | U = Unsatisfactory (requires corrective action) | N/A = Not applicable\nFor each U rating, describe the finding and set a corrective action due date.\n\nCHEMICAL STORAGE AND INVENTORY\nâ˜ All chemicals are properly labeled (name, hazard, owner)\nâ˜ Incompatible chemicals are properly segregated (acids/bases, oxidizers/flammables)\nâ˜ Flammable solvents are stored in approved flammable storage cabinets; quantity within limits\nâ˜ No chemical containers are stored on the floor (except large carboys in secondary containment)\nâ˜ All peroxide-forming chemicals have been dated and checked per SOP\nâ˜ Chemical inventory matches SafetyIQ records\n\nEMERGENCY EQUIPMENT\nâ˜ Eyewash station accessible and unobstructed; last flushed within [PERIOD]\nâ˜ Emergency shower accessible and unobstructed; last tested within [PERIOD]\nâ˜ Fire extinguisher present, inspection tag current, pin and seal intact\nâ˜ Spill kit present and stocked (verify contents vs. posted inventory)\n\nWASTE MANAGEMENT\nâ˜ Hazardous waste containers properly labeled with contents and accumulation date\nâ˜ Satellite accumulation area within allowed quantity limits\nâ˜ Biohazardous waste bags/containers properly labeled; sharps containers not overfull\nâ˜ No unauthorized disposal of chemicals to drain or trash\n\nFUME HOOD AND BSC\nâ˜ Fume hood alarm functioning; certification sticker current\nâ˜ Fume hood sash at or below working height when not in use\nâ˜ BSC certification sticker current; UV lamp functioning\n\nGENERAL HOUSEKEEPING\nâ˜ Lab exits and aisles clear of obstruction (minimum 28-inch clear aisle)\nâ˜ No food or drink in the laboratory\nâ˜ PPE available and in serviceable condition\nâ˜ Electrical cords and equipment in good condition (no fraying, no daisy-chain extension cords)\nâ˜ Laboratory area clean and orderly; benches and floors free of chemical contamination\n\nFINDINGS SUMMARY:\n[List all U items with corrective actions and due dates]\n\nInspector Signature: _______________ Date: _______________\nSupervisor Acknowledgment: _______________ Date: _______________"
      },
    ],
  },
    ...
    sections: [
      {
        ...
        body: "INSTRUCTIONS: Complete this form for all needlestick injuries, sharps exposures, mucous membrane splashes, or skin contact with blood or OPIM. Submit to EHS within 24 hours of the incident. This form is CONFIDENTIAL MEDICAL INFORMATION.\n\nSECTION 1 â€” EMPLOYEE INFORMATION (CONFIDENTIAL)\nEmployee Name: _______________ Job Title: _______________\nDepartment: _______________ Date of Birth: _______________ Sex: ___\nDate of Incident: _______________ Time: _______________ Location: _______________\nLength of Employment: _______________ Date of HBV Vaccination (if known): _______________\n\nSECTION 2 â€” INCIDENT DESCRIPTION\nDescribe how the exposure occurred (please be specific):\n_______________\n\nType of exposure:\nâ˜ Needlestick/sharps puncture\nâ˜ Mucous membrane splash (eyes, nose, mouth)\nâ˜ Non-intact skin contact (cut, abrasion, rash)\nâ˜ Other (describe): _______________\n\nBody part(s) affected: _______________\nDepth of injury (for sharps): â˜ Superficial (scratch) â˜ Moderate (definite puncture) â˜ Deep (visible blood on device)\n\nMaterial involved: â˜ Blood â˜ Blood-contaminated fluid â˜ Other potentially infectious material (specify): _______________\n\nSource material (the device/material that caused the exposure): _______________\nWas the device involved: â˜ A safety-engineered device? â˜ A conventional device? â˜ Broken glass?\n\nSECTION 3 â€” SOURCE INDIVIDUAL\nWas the source individual identifiable? â˜ Yes â˜ No\nIf yes, has the source individual been informed? â˜ Yes â˜ No â˜ N/A\nSource individual consent for testing: â˜ Obtained â˜ Refused â˜ Not applicable\nKnown source HBV status: _______________ Known HIV status: _______________\n\nSECTION 4 â€” IMMEDIATE ACTIONS TAKEN\nFirst Aid: â˜ Wound washed with soap and water â˜ Mucous membrane flushed with water â˜ Other: _______________\nWas the employee referred for post-exposure medical evaluation? â˜ Yes â˜ No\nDate/Time of medical referral: _______________ Facility: _______________\n\nSECTION 5 â€” CORRECTIVE ACTION\nImmediate corrective actions taken to prevent recurrence:\n_______________\n\nLong-term corrective action (CAPA) required? â˜ Yes â€” CAPA # ________ â˜ No\n\nSupervisor Signature: _______________ Date: _______________\nEHS Review Signature: _______________ Date: _______________"
      },
    ],
  },
    ...
    sections: [
      {
        ...
        body: "Employee Name: _______________ Position Title: _______________\nDepartment / Lab: _______________ Start Date: _______________\nOrientation Conducted by: _______________ Date of Orientation: _______________\n\nINSTRUCTIONS: Check each item as it is completed. Both the new employee and the person conducting the orientation must initial/sign each section. This completed form is retained in the employee's training file.\n\nSECTION 1 â€” GENERAL EHS ORIENTATION (all employees)\nâ˜ Overview of [COMPANY NAME] EHS program and the SafetyIQ platform\nâ˜ How to report workplace injuries, illnesses, and near misses\nâ˜ How to access the Emergency Action Plan and evacuation routes\nâ˜ Location of emergency exits, assembly points, and shelter areas\nâ˜ How to report a fire or emergency (pull station, call 911, building number)\nâ˜ Location of nearest fire extinguisher to work area\nâ˜ Right-to-know rights: access to SDS, chemical inventory, and Written HazCom Program\nâ˜ Incident reporting requirements and non-retaliation policy\n\nSECTION 2 â€” LABORATORY SAFETY (laboratory employees only)\nâ˜ Chemical Hygiene Plan reviewed; location of the CHP and SDS library shown\nâ˜ Location and use of eyewash station and emergency shower demonstrated\nâ˜ Minimum PPE requirements for the laboratory reviewed\nâ˜ Chemical storage and waste disposal procedures reviewed\nâ˜ Fume hood proper use reviewed and demonstrated\nâ˜ Biohazardous waste handling and sharps disposal reviewed (if applicable)\nâ˜ Bloodborne Pathogen initial training completed (if applicable)\nâ˜ Autoclave or BSC training completed (if applicable)\n\nSECTION 3 â€” ACKNOWLEDGMENTS\nâ˜ Employee acknowledges receipt and review of Emergency Action Plan\nâ˜ Employee acknowledges receipt and review of Chemical Hygiene Plan (if lab employee)\nâ˜ Employee acknowledges receipt and review of Bloodborne Pathogens ECP (if applicable)\nâ˜ Employee acknowledges understanding of incident reporting procedures\n\nEMPLOYEE SIGNATURE: _______________ DATE: _______________\n'I confirm that I have received the EHS orientation described above and understand my responsibilities.'\n\nORIENTATION PROVIDER SIGNATURE: _______________ DATE: _______________\n\nSUPERVISOR ACKNOWLEDGMENT: _______________ DATE: _______________"
      },
    ],
  },
