...
Generated: 2026-07-02T17:17:00.069Z by `scripts/check-migration-status.ts`
...
**43 of 45 local database updates are live in production** — 42 recorded in the migration history and 1 applied by hand and verified directly against the live schema. **2 are NOT applied**, and 2 of those have application code that already depends on them.
